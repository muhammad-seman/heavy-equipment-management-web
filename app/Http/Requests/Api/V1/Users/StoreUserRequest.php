...
class StoreUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'employee_id' => ['required', 'string', 'max:50', 'unique:users,employee_id', 'regex:/^[A-Z]{2,3}\d{3,4}$/'],
            'department' => ['required', 'string', 'max:255'],
            'position' => ['required', 'string', 'max:255'],
            'certification_level' => ['required', Rule::in(['basic', 'intermediate', 'advanced', 'expert'])],
